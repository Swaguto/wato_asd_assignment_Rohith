...
void PlannerNode::mapCallback(const nav_msgs::msg::OccupancyGrid::SharedPtr msg) {
  ...
  // The map may have revealed new obstacles: replan for the active goal
...
void PlannerNode::timerCallback() {
  ...
  // Give up if we've been chasing the goal for too long
...
void PlannerNode::cancelGoal() {
  ...
  // Publish an empty path so the controller knows to stop the robot
